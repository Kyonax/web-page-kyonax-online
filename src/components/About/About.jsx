    ...
    return (
        <div className='w-full h-screen flex flex-wrap items-center justify-center text-left text-white' >
            ...
            <div className='w-full lg:w-3/5'>
                ...
                <p className='ml-6 mr-6 mt-[-6px] text-[17px] font-thin '> <a href="https://www.linkedin.com/in/kyonax/">Cristian Moreno</a> es un <a className='color-span'>Desarrollador Full Stack, Creador de Contenido, Editor/Diseñador Multimedia, y Community Manager</a> enfocado en la creación/desarrollo de Comunidades utilizando herramientas y tecnologías digitales, nacido en Bogotá (Colombia) siendo el creador y fundador de la marca Kyonax encargada de ofrecer Servicios profesionales de Publicidad, Desarrollo, Diseño, Manejo de Comunidades Digitales, Asesorías, entre otros.</p>
                <p className='ml-6 mr-6 mt-9 text-[17px] font-thin '>Kyonax es una marca conformada por tres importantes dependencias de Servicios, cada dependencia asignada a un respectivo nombre — <a className='color-span'>Dot Kyo, Kyonax Lost in the Multiverse, Kyo NFT</a> — cuyo objetivo es brindar comodidad, identidad, y enfoque a cada una de estas dependencias.</p>
